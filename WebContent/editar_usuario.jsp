                        ...
                        <div class="form">
                          <form class="form-validate form-horizontal" id="feedback_form" method="POST" action="EditarUsuarioServlet">
                            ...
                            <div class="form-group ">
                              ...
                              <div class="col-lg-10">
                                <input class="form-control" id="idUniversidad" name="idUniversidad" type="text" value="${usuario.getIdUniversidad()}"/>
                              </div>
                            </div>
                            ...
                            <div class="form-group ">
                              ...
                              <div class="col-lg-10">
                                <input class="form-control" id="idEmpresa" name="idEmpresa" type="text" value="${usuario.getIdEmpresa()}"/>
                              </div>
                            </div>
