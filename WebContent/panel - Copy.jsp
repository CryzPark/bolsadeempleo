...
<body>
  ...
  <section id="container" class="">
    ...
    <header class="header dark-bg">
      ...
      <!--logo start-->
      <a href="panel.jsp" class="logo"><img src="img/favicon.png" class="img-fluid logo"></a>
      <a href="panel.jsp" class="logo">&nbsp;&nbsp; CI<span class="lite">BTF</span></a>
